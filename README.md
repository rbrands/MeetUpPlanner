...
The application is divided into two parts: 
  ...
  * The back-end is a set of Azure Functions that provide the business logic for the application. The Azure Functions are hosted in an Azure Functions App. The Azure Functions are implemented in C# and use the .NET 8 runtime. The Azure Functions use Azure Cosmos DB to store the data.
